...
function changeBg(status) {
    if (status === 'Clouds') {
        document.body.style.backgroundImage = 'url(img/cloudybro.jpg)';
    } else if (status === 'Rain') {
        document.body.style.backgroundImage = 'url(img/zdenek-machacek-w7ULTUtfccs-unsplash.jpg)';
    } else if (status === 'Clear') {
        document.body.style.backgroundImage = 'url(img/clearrrr.jpg)';
    }
    else if (status === 'Snow') {
        document.body.style.backgroundImage = 'url(img/pexels-visit-almaty-848599.jpg)';
    }
